...
namespace apbd_9.Context
{
    public partial class TripsContext : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder) => optionsBuilder.UseSqlServer("Data Source=DESKTOP-QSVGNMU\\SQLEXPRESS02;Initial Catalog=mydb;Integrated Security=True;Trust Server Certificate=True;");
